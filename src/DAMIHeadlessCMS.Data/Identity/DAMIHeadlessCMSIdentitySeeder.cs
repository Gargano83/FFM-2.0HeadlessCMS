...
///   "DAMIHeadlessCMS": { "SeedAdmin": { "Email": "admin@example.com", "Password": "Pa$$w0rd1" } }
/// </summary>
public static class DAMIHeadlessCMSIdentitySeeder
{
    public static async Task SeedAsync(IServiceProvider services, IConfiguration configuration, CancellationToken ct = default)
    {
        ...
        var seedEmail = configuration["DAMIHeadlessCMS:SeedAdmin:Email"];
        var seedPassword = configuration["DAMIHeadlessCMS:SeedAdmin:Password"];
