...
/// da un host applicativo con Dependency Injection, dato che MyCms.Data è una
/// libreria e non ha un proprio Program.cs.
///
/// A runtime, l'app host NON usa questa classe: le DbContextOptions arrivano
/// invece da AddMyCmsData(connectionString) registrato in Program.cs dell'host.
///
...
/// MYCMS_CONNECTIONSTRING. appsettings.json NON va committato in git.
/// </summary>
public class CmsDbContextFactory : IDesignTimeDbContextFactory<CmsDbContext>
{
    public CmsDbContext CreateDbContext(string[] args)
    {
        ...
        var connectionString =
            ...
            ?? configuration["MYCMS_CONNECTIONSTRING"]
            ?? throw new InvalidOperationException(
                "Connection string 'Default' non trovata per la creazione a design-time di CmsDbContext. " +
                "Crea 'src/MyCms.Data/appsettings.json' copiando appsettings.example.json e valorizzando " +
                "ConnectionStrings:Default, oppure imposta la variabile d'ambiente MYCMS_CONNECTIONSTRING.");
